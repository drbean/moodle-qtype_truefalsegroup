...
// $string['pluginname'] = 'truefalsegroup';
...
$string['true'] = 'True';
$string['pluginname'] = 'True/False with group grade';
$string['pluginname_help'] = 'In response to a question (that may include a image) the respondent chooses from true or false, and gets group grade.';
$string['pluginname_link'] = 'question/type/truefalsegroup';
